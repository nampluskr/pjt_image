...
if __name__ == "__main__":
    ...
    p.add_argument("--log_dir", type=str, default="log_pt_mnist_cae")
    args = p.parse_args()
    ...
    cae.compile(optim=torch.optim.Adam(cae.parameters()),
               loss_fn=nn.BCELoss(),
    ...
    trained_cae.compile(optim=torch.optim.Adam(cae.parameters()),
               loss_fn=nn.MSELoss(),
               metric_fn=binary_accuracy, metric_name="acc")
